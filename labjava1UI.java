...
public class labjava1UI extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String s_low = jTable1.getValueAt(row, 0).toString();
        String s_high = jTable1.getValueAt(row, 1).toString();
        String s_step = jTable1.getValueAt(row, 2).toString();

        String buf;
        double res = 0.0;
        System.out.println("TimerTask начал свое выполнение в:" + new Date());
    
        client.client(s_low, s_high, s_step);

            buf = client.getRes();
            res = Double.parseDouble(buf);

            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setValueAt(res, row, 3);
